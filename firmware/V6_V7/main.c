...
void outputEN(void){
    ...
    static bool need_to_clear_LEDs_for_cell_voltage_indicator = 1;
        ...
        if (!ISL_GetSpecificBits_cached(ISL.ENABLE_DISCHARGE_FET)  //If discharge isn't already enabled
            ...
            && safetyChecks()
                ...
                switch(startup_led_step){
                    case 0:
                        ...
                        ledBlinkpattern (1, 0b100, 333, 0, 0, 0);
                    ...
                    case 1:
                        LED_code_cycle_counter.enable = true;
                        ledBlinkpattern (1, 0b110, 333, 0, 0, 0);
                        if (LED_code_cycle_counter.value > 1){
                            startup_led_step++;
                            resetLEDBlinkPattern();
                        }
                    ...
                    case 2: 
                        LED_code_cycle_counter.enable = true;
                        ledBlinkpattern (1, 0b010, 333, 0, 0, 0);
                        if (LED_code_cycle_counter.value > 1){
                            startup_led_step++;
                        ...
                        default:
                            Set_LED_RGB(0b001);       //Set LED to blue after fancy startup LEDs
                            break;
                } 
        }
            ...
            ledBlinkpattern (num_blinks, 0b111, 500, 500, 1000, 1000);
...
void error(void){
    ...
    if (critical_i2c_error || past_error_reason.ISL_BROWN_OUT){         
        ...
        while(1){                                               //It's called critical for a reason
            ...
            if (past_error_reason.ISL_BROWN_OUT){
                ledBlinkpattern(16, 0b100, 500, 500, 1000, 1000);    //ISL brown out
            }
            else{
                ledBlinkpattern(15, 0b100, 500, 500, 1000, 1000);    //critical i2c error
            }
    ...
    if (past_error_reason.ISL_INT_OVERTEMP_FLAG) ledBlinkpattern (4, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.ISL_EXT_OVERTEMP_FLAG) ledBlinkpattern (5, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.ISL_INT_OVERTEMP_PICREAD) ledBlinkpattern (6, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.THERMISTOR_OVERTEMP_PICREAD) ledBlinkpattern (7, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.CHARGE_OC_FLAG) ledBlinkpattern (8, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.DISCHARGE_OC_FLAG) ledBlinkpattern (9, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.DISCHARGE_SC_FLAG) ledBlinkpattern (10, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.DISCHARGE_OC_SHUNT_PICREAD) ledBlinkpattern (11, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.CHARGE_ISL_INT_OVERTEMP_PICREAD) ledBlinkpattern (12, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.CHARGE_THERMISTOR_OVERTEMP_PICREAD) ledBlinkpattern (13, 0b100, 500, 500, 1000, 1000);
    else if (past_error_reason.UNDERTEMP_FLAG) ledBlinkpattern (14, 0b100, 500, 500, 1000, 1000);
    else if (full_discharge_trigger_error) ledBlinkpattern (3, 0b001, 300, 300, 750, 750);       //trigger is pulled but battery is low
    else ledBlinkpattern (20, 0b100, 500, 500, 1000, 1000);                                                                  //Unidentified Error
